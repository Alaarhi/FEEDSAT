            ...
            ?>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 desktop pm-center pm-columnPadding-30 pm-column-spacing">
                    ...
                    <div class="pm-single-testimonial-shortcode">
                    	<div style="background-image:background-image: url(<?php if($prof['gender']=="1") echo  "img/AvatarFemaleProf.png"; else echo  "img/AvatarProf2.png";?>);" class="pm-single-testimonial-img-bg">
