...
<?php
$requetecomments = $bd->prepare('SELECT * FROM comment WHERE approved = 0 ');
$comments = $requetecomments->fetchALL(PDO::FETCH_ASSOC);
?>
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tr class="gradeA">
                                        ...
                                        <td><?php echo $comments['timestamp'] ?> </td>
                                            <td>OSX.4+</td>
                                            <td class="actions">
                    ...
                    <div class="panel-body">
                        <div class="modal-wrapper">
                            <div class="modal-text">
                                <p>Are you sure that you want to disapprove this comment?</p>
                            </div>
                        </div>
