...
$req = $bd->query('select * from comment where timestamp <= "'.$lastTime.'" order by timestamp desc');
}
$i=0;
$bloc="";
$shown="";
    ...
    $bloc=$bloc.'<div class="pm-comment-box-container">
                                            ...
                                            <div class="pm-comment-box-avatar-container">
                                                ...
                                                <ul class="pm-comment-author-list">
                                                    <li><p class="pm-comment-name">'.$student['surname'].' '.$student['name'].'</p></li>
                                            ...
                                            <div class="col-md-1" style="padding-top: 25px">
                                                ...
                                                <button id="'.$result["id"].'" class="clap" onclick="('.$result["id"].')">
                                                    <span>
                                                      <!--  SVG Created by Luis Durazo from the Noun Project  -->
                                                      <svg id="'.$result["id"].'1" class="clap--icon" xmlns="http://www.w3.org/2000/svg" viewBox="-549 338 100.1 125">
